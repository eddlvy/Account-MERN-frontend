  ...
  return (
    <div className="div-register">
      ...
      <form className="form-register" onSubmit={postToServer} method="post">
        ...
        <input className="input-register" type="text" id="nombre" value={nombre} onChange={(e) => { setNombre(e.target.value) }} required></input>
        <label className="label-register">Escribe Clave de Entrada</label>
        <input className="input-register" type="password" id="clave" value={clave} onChange={(e) => { setClave(e.target.value) }} required></input>
